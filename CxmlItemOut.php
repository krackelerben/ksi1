...
/**
 * CxmlItemOut models the ItemOut elements in the OrderRequest document.
 *
 *<!ELEMENT ItemOut (ItemID, Path?, ItemDetail?, (SupplierID | SupplierList)?,
 *    ShipTo?, Shipping?, Tax?, Distribution*, Contact*, Comments?)>
 *<!ATTLIST ItemOut
 ...
 */
class CxmlItemOut implements ArrayAccess
{
    ...
    /**
     * Create an ItemOut from array of data.
     *
     * @param array $arr
     * @return CxmlItemOut
     */
